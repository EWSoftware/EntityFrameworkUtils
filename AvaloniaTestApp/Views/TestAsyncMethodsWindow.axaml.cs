...
// File    : TestAsyncMethodsWindow.cs
// Author  : Eric Woodruff
// Updated : 08/17/2025
//
// This file contains the window used to test the asynchronous methods in the Entity Framework Utilities library.
// Note that the SubmitChangesAsync and ExecuteNonQueryAsync methods are demonstrated in the Demo Data Table and
// State Codes windows.
//
//    Date     Who  Comments
// ==============================================================================================================
...
public partial class TestAsyncMethodsWindow : Window
{
    ...
    /// <param name="sender">The sender of the event</param>
    /// <param name="e">The event arguments</param>
    private async void btnLoadByKey_Click(object sender, RoutedEventArgs e)
    {
        if(cts.IsCancellationRequested)
            cts = new();
    ...
    /// <param name="sender">The sender of the event</param>
    /// <param name="e">The event arguments</param>
    private async void btnCRUDMethods_Click(object sender, RoutedEventArgs e)
    {
        if(cts.IsCancellationRequested)
            cts = new();
    ...
    /// <param name="sender">The sender of the event</param>
    /// <param name="e">The event arguments</param>
    private async void btnExecuteMethodQueryAsync_Click(object sender, RoutedEventArgs e)
    {
        if(cts.IsCancellationRequested)
            cts = new();
