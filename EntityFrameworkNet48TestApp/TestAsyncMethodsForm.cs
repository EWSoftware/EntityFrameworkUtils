    ...
    public partial class TestAsyncMethodsForm : Form
    {
        ...
        private async void btnLoadByKey_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var p = await dc.LoadByKeyAsync<ProductInfo>(new object[] { productId }, cts.Token).SingleOrDefaultAsync(cts.Token);
        ...
        private async void btnCRUDMethods_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var r = await dc.LoadByKeyAsync<DemoTable>(new object[] { newRow.ListKey }, cts.Token).SingleAsync(cts.Token);
                ...
                r = await dc.LoadByKeyAsync<DemoTable>(new object[] { r.ListKey }, cts.Token).SingleAsync(cts.Token);
                ...
                var d = await dc.LoadByKeyAsync<DemoTable>(new object[] { r.ListKey }, cts.Token).SingleOrDefaultAsync(cts.Token);
